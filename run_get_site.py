...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', '-m', type=str, default="CASPET",  choices=["CASPET", "CASPEA"], help='model_type for Grad-CAM, CASPET for thermostability and CASPEA for pH tolerance')
