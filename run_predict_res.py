...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', '-m', type=str, default='APCNetT', choices=['APCNetT', 'APCNetAA', 'APCNetAL'], 
    ...
    DEMO_APCNet.main_predict_res(args.checkpoint, args.model_type, 1, args.input_path, args.output_file)
