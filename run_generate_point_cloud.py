...
if __name__ == "__main__":
    ...
    parser.add_argument('--point_min_num', '-n', type=int, default=256, help='minimum number of points in the point cloud') 
    parser.add_argument('--point_max_num', '-x', type=int, default=1536, help='maximum number of points in the point cloud')
    ...
    DEMO_MICRO_ENV.mian_generate_point_cloud(args.input_dir, args.json_pqr_site, args.point_min_num, args.point_max_num, args.output_dir)
    print('Done!')